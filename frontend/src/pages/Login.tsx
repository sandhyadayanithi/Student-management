...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Ensure we navigate to the events page using the rollNumber upon success
      if (student.rollNumber) {
        navigate(`/events/${student.rollNumber}`);
      } else {
        throw new Error('Valid rollNumber not found in response');
      }
    } catch (err: any) {
